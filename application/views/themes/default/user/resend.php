	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 jumbotron">		
                ...
                <ul class="list-unstyled" style="line-height: 2">
                    ...
                    <li><span class="fa fa-check text-success"></span> Can get free business ads feature listing <small>(only new verified listing)</small></li>
					  ...
					  <p><a href="<?php echo base_url('login'); ?>" class="btn btn-success btn-block"><?php echo lang_key('alread_haveacc'); ?></a></p>
			</div>
			...
			<div class="col-lg-6">
				...
				echo form_open('resend','class="form-horizontal jumbotron" data-toggle="validator"'); ?>
					
				<div class="col-lg-12">
					<h4><?php echo lang_key('resend') ?></h4>
				</div>
				...
				<!-- button -->	
				<div class="col-lg-12">
					<input type="submit" class="btn btn-embossed btn-primary btn-hg btn-block" value="<?php echo lang_key('resend_btn') ?>" />
				</div>
				<?php echo form_close(); ?>	
			</div>
