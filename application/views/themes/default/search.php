						...
						<div class="col-xs-12 col-sm-9">				
							...
							<div id="bbpress-forums">
									<div class="bbp-template-notice info">
										<p class="bbp-topic-description"><?php echo lang_key('you_are_searching').'&nbsp<b class="text-danger">'.$searchkey.'</b>&nbsp'.lang_key('with_total_result').'&nbsp<b class="text-danger">'.custom_number_format($this->topic_model->countSearchMatch()).'</b>'; ?>.
										</p>
									</div>
										...
										<li class="bbp-header">
											...
											<li class="bbp-body">
												...
												<ul class="odd topic type-topic status-publish hentry">
													<span class="text-danger"><?php echo lang_key('no_result_found').'&nbsp<strong>'.$searchkey.'</strong>'; ?></span>
												</ul>
												<?php } ?>
